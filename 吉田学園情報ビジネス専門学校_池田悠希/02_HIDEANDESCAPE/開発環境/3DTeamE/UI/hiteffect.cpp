...
void CHitEffect::HitEffectCreate(D3DXVECTOR3 pos, D3DXVECTOR3 size, D3DCOLOR col)
{
	for (int nCount = 0; nCount < 10; nCount++)
	{
		...
		CHitEffect::Create(pos, D3DXVECTOR3(cosf(D3DXToRadian(fRandRotX)) * fRandSpeed, sinf(D3DXToRadian(fRandRotY)) * -(fRandSpeed), cosf(D3DXToRadian(fRandRotZ))*fRandSpeed), ZEROVECTOR3,size,col);
	}
}
