...
HRESULT CMap01::Init(void)
{
	...
	//アイテムセット
	CItem::Create(D3DXVECTOR3(-70.0f, 25.0f, 550.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f));
	...
	//エネミーセット
	m_pUav[0] = CUav::Create(D3DXVECTOR3(-190.0f, 0.0f, 480.f), D3DXVECTOR3(0.0f, 0.0f, 0.0f));
	if (m_pUav[0] != NULL)
	{
...
void CMap01::Update(void)
{
	...
	{
		CManager::GetFade()->SetFade(CManager::MODE_MAP02);
	}
#endif
	//=============================================================================
	...
	if (m_pUav[0]->EnemyCall() == true)
	{
		...
		{		
			//来ていなければ追加
			m_pLightEnemy[1] = CLightEnemy::Create(D3DXVECTOR3(-30.0f, 0.0f, 650.f), D3DXVECTOR3(0.0f, 0.0f, 0.0f));
			//巡回位置セット
