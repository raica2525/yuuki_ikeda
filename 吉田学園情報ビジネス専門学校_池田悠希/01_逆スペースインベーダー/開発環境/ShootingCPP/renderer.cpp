...
#ifdef _DEBUG
	// デバッグ情報表示用フォントの生成
	D3DXCreateFont(m_pD3DDevice, 100, 0, 0, 0, FALSE, SHIFTJIS_CHARSET,
...
////ポリゴン数表示
////・・・・・・・・・・・・・・・・・・・・・・・・・・・
//void CRenderer::DrawRemain(void)
//{
//	RECT rect = { (SCREEN_WIDTH/2)-100, 0, SCREEN_WIDTH, SCREEN_HEIGHT };
//	char str[256];
//
//	wsprintf(str, "Remain:%d\n", CScene::GetNumAll());
//
//	// テキスト描画
