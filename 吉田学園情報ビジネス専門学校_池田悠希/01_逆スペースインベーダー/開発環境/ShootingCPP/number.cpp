...
HRESULT CNumber::Init(void)
{
    ...
    //テクスチャ座標の設定
    pVtx[0].tex = D3DXVECTOR2(m_nValue * 0.1f, 0);
    pVtx[1].tex = D3DXVECTOR2((m_nValue + 1) * 0.1f, 0);
    pVtx[2].tex = D3DXVECTOR2(m_nValue * 0.1f, 1);
    pVtx[3].tex = D3DXVECTOR2((m_nValue + 1) * 0.1f, 1);
    ...
    //頂点カラーの設定(0～255)
    // pVtx[0].col = D3DCOLOR_RGBA(0, 50, 255, 255);//aは透明度
    // pVtx[1].col = D3DCOLOR_RGBA(0, 50, 255, 255);//aは透明度
    // pVtx[2].col = D3DCOLOR_RGBA(0, 50, 255, 255);//aは透明度
    // pVtx[3].col = D3DCOLOR_RGBA(0, 50, 255, 255);//aは透明度
    m_pVtxBuff->Unlock();
...
//クリエイト関数
//・・・・・・・・・・・・・・・・・・・・・・・・・・・
CNumber* CNumber::Create(int nValue, D3DXVECTOR3 pos, D3DXVECTOR3 size, D3DCOLOR col)
{
