...
HRESULT CNumber::Init(void)
{
	...
	//テクスチャ座標の設定
	pVtx[0].tex = D3DXVECTOR2(m_nValue*0.1, 0);
	pVtx[1].tex = D3DXVECTOR2((m_nValue +1)*0.1, 0);
	pVtx[2].tex = D3DXVECTOR2(m_nValue*0.1, 1);
	pVtx[3].tex = D3DXVECTOR2((m_nValue +1)*0.1, 1);
