...
private:
	...
	void GetHittedObject(CScene** pScene, CEnemy** apHitEnemy, int* pHitEnemyCount, CEnemy** pClosestEnemy, CScene2d** pClosestTile);
	void HitTile(CScene2d* pTile, CScore* pScore);
	void SetLaserSize(D3DXVECTOR3 size);
    CPolygon* m_pPolygon;
